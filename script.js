    ...
    (t = () => {
        ...
        (function () {
            ...
            async function u(e) {
                ...
                let r = new URL(a.src);
                return r.pathname = r.pathname.replace("/script.js", "/flags/script.js"), import(r.href).then(n => n.gather(t, e));
            }
            ...
            async function f(e, t, n) {
                return c({ type: "event", data: { name: e, data: t }, options: { withReferrer: !0, flags: null == n ? void 0 : n.flags } });
            }
            ...
            let w = e(),
                y = () => {
                    ...
                    window.va = function (e, n) {
                        "beforeSend" === e ? t = n : "event" === e ? n && f(n.name, n.data, n.options) : "pageview" === e && n && (n.route && (o = n.route), n.path && (l = n.path), d({ withReferrer: s }), s = !1), "enableCookie" === e && h();
                    }, null == (e = window.vaq) || e.forEach(([e, t]) => { window.va(e, t); });
                };
